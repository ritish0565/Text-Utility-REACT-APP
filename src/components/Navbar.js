    ...
    return (
        <nav className={`navbar navbar-expand-lg navbar-${props.mode} bg-${props.mode}`} >
            <div className="container-fluid" style={{color: props.mode==="dark"?"white":"black"}}>
                ...
                {/* <div className={`form-check form-switch mx-4 text-${props.red===true?"dark":"light"}`}>
                ...
                <div className={`form-check form-switch mx-4 text-${props.mode==="light"?"dark":"light"}`}>
                    ...
                    <label className="form-check-label" htmlFor="flexSwitchCheckDefault">Enable Dark Theme</label>
                </div>
            </div>
